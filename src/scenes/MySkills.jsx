      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            I&apos;m a prospective web developer with a background in Computer
            Science and a passion for building websites and applications.
          </p>
        </motion.div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-16 gap-32 mb-16">
        ...
        >
          <div className=" relative h-32">
            ...
            <p className=" mt-10">
              Consist of experiences from school and personal projects that I
              have done outside of school curriculum. Other than Frontend
              Development, I have also touched on database management and some
        ...
        >
          <div className="flex flex-col relative h-32">
            ...
            <p className=" mt-10">
              I&apos;ve picked up multiple languages such as HTML, CSS,
              Javascript, React and Python and touched on other frameworks. I
              take this chance to broaden my knowledge and find something that
              is for me.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col relative h-32">
            ...
            <p className=" mt-10">
              Working in a team has allowed me to understand that every teammate
              is crucial for success. This had taught me to be empathetic to
              people around me and to work efficiently as a team
            </p>
          </div>
        </motion.div>
      </div>
